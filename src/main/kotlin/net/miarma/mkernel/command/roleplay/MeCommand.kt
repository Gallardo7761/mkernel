package net.miarma.mkernel.command.roleplay
...
@Singleton
class MeCommand @Inject constructor(private val configService: ConfigService, private val messageService: MessageService) {
    fun register() {
